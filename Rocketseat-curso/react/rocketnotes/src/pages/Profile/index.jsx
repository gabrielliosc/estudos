...
export function Profile() {
    ...
    const [passwordOld, setPasswordOld] = useState() //Não passa a senha para a pessoa digitar a senha antiga
    ...
    return (
        <Container>
            ...
            <Form>
                ...
                <Input placeholder="Senha nova" type="password" icon={FiLock} onChange={e => setPasswordNew(e.target.value)}/>
